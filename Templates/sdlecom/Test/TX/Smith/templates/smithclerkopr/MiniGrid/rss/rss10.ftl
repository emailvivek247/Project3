...
<#foreach doc in searchResult.docs>
        <rdf:li rdf:resource="http://www.sample.com/id=${doc.get("pk_key")}" />
</#foreach>
      </rdf:Seq>
    </items>
  </channel>
<#foreach doc in searchResult.docs>
  <item rdf:about="http://www.sample.com/id=${doc.get("pk_key")}">
    <title><![CDATA[${doc.get("pk_key")}:]]></title>
    <link>http://www.sample.com/id=${doc.get("pk_key")}}</link>
