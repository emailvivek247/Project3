...
jQuery.fn.createAppend = function(element, attrs, content){
  ...
  if (/*jQuery.browser.msie && */parentElement && parentElement.nodeName.toLowerCase() == 'table' && element.nodeName.toLowerCase() == 'tr') {
            ...
            case 'style':
                if (typeof attrValue == 'string') {
                    ...
                    for (styleName in attrValue) {
                        if (styleName.trim() != '') {
                            element.style[styleName] = attrValue[styleName];
                        };
                    };
                };
                break;
...
__FlyDOM_setText = function(element, content){
    ...
    if (!content.match || content.match(isHtml) != null && element.tagName.toUpperCase() != 'TEXTAREA') {
