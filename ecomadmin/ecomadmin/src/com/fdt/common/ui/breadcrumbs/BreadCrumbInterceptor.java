package com.fdt.common.ui.breadcrumbs;
...
public class BreadCrumbInterceptor extends HandlerInterceptorAdapter {
	...
	private void emptyCurrentBreadCrumb(HttpSession session) {
		session.setAttribute("currentBreadCrumb",
				new LinkedList<BreadCrumbLink>());
	}
	...
	private void processAnnotation(HttpServletRequest request,
		...
		Map<String, LinkedHashMap<String, BreadCrumbLink>> breadCrumb = this.getBreadCrumbLinksFromSession(session);
	...
	private BreadCrumbLink getBreadCrumbLink(HttpServletRequest request, Link link, LinkedHashMap<String,
		BreadCrumbLink> familyMap) {
	...
	private Map<String, LinkedHashMap<String, BreadCrumbLink>> getBreadCrumbLinksFromSession(HttpSession session) {
		Map<String, LinkedHashMap<String, BreadCrumbLink>> breadCrumb = (Map<String, LinkedHashMap<String, BreadCrumbLink>>)
			session.getAttribute(BREAD_CRUMB_LINKS);
		return breadCrumb;
	}
