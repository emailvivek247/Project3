...
public class Test {
    ...
    public static Map<String, String> parseParameters(URI uri) throws URISyntaxException {
        if (!isCompositeURI(uri)) {
            ...
            CompositeData data = Test.parseComposite(uri);
    ...
    public static void main(String[] args)  throws Exception {
    	URI uri = new URI("tcp://localhost:61616&jms.optimizeAcknowledge=false&wireFormat.maxInactivityDuration=600000&daemon=true");
    	Map options = parseParameters(uri);
    	if (!options.isEmpty()) { 
    		System.out.println("The Output is ===" + options);
    	}  
