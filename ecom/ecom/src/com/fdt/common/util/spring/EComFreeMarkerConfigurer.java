 ...
 *
 */
public class EComFreeMarkerConfigurer extends FreeMarkerConfigurer {

    private static final Logger logger = LoggerFactory.getLogger(EComFreeMarkerConfigurer.class);
