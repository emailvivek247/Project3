...
public interface EComFacadeServiceRS {
    ...
    public List<FirmUserDTO> getFirmUsers(
        @WebParam(name="adminUserName") String adminUserName,
        @WebParam(name="accessId") String accessId);
    ...
    @WebMethod
    public List<PayPalDTO> paySubscriptions(@WebParam(name="subscriptionDTO") SubscriptionDTO subscriptionDTO)
    ...
    public List<PayAsUGoTx> doSalePayAsUGo(
        @WebParam(name="userName") String userName,
        @WebParam(name="webTransactionDTO") PayAsUSubDTO payAsUGoTransactionDTO)
    ...
    @WebMethod
    public List<ShoppingCartItem> doSalePayAsUGoInfo(@WebParam(name="webTransactionDTO") PayAsUSubDTO payAsUGoTransactionDTO)
        throws SDLBusinessException;
    ...
    @WebMethod
    public void deleteUserAlerts(
        @WebParam(name="userName") String userName,
        @WebParam(name="userAlertIdList") List<Long> userAlertIdList);
