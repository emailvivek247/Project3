...
VALUES ('PIMA', 'Pima County Superior Court', 'Y', 'Phoenix', 'AZ', 'Y', 'America/Los_Angeles', @NODE_ID, GETDATE(), GETDATE(), 'SYSTEM', 
	'', 'N', 'N', 'Pima County', 'SYSTEM', 72, 30, 30)
GO

--- INSERT MERCHANT INFORMATION ---
DECLARE @SITE_ID AS INT = (SELECT TOP 1 ID FROM ECOMM_SITE WHERE NAME = 'PIMA')
...
VALUES ('Pima County Superior Court - TERMS AND CONDITIONS', GETDATE(), GETDATE(), 'SYSTEM', @SITE_ID, @TERM_TYPE_ID, 'Y', 'SYSTEM')
GO
...
INSERT INTO ECOMM_BANK_DETAILS (SITE_ID, FROM_FNAME, FROM_LNAME, FROM_MINITIAL, FROM_ADDRLINE1, FROM_ADDRLINE2, FROM_CITY, FROM_STATE, FROM_ZIPCODE, FROM_PHONENUM,
						...
						VALUES (@SITE_ID, 'AMCAD', '', '','15867 N Mountain Road','','Broadway','VA','22815','','BB&T','111-20/121','056005318','0005132069613', 80000, 80000, 89999,  
...
VALUES (@SITE_ID, 'Web Payments/PIMA/', 'webmaster@pima.gov', 'Payment Confirmation - Roam Pima Court Records', 
	'Subscription Change Notification - Roam Pima Court Records', 'Cancelled Subscription Notification - Roam Pima Court Records', 
	'Subscription Reactivated - Roam Pima Court Records', 'Recurring Payment Posted Successfully - Roam Pima Court Records', 
	'Recurring Payment Failed - Roam Pima Court Records',
	...
	'recurringPaymentUnsuccessfulTemplate.stl', GETDATE(), GETDATE(), 'SYSTEM', 'Y', 'Web Purchase Confirmation - Roam Pima Court Records', 'webPaymentConfirmation.stl', 
	'Subscription Removed - Roam Pima Court Records', 'removeSubscription.stl', 'SYSTEM', 'Access Authorization - Roam Pima Court Records', 'accessAuthorization.stl')
GO