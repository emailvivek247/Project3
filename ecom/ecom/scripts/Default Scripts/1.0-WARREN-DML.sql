...
VALUES ('WARREN', 'City of Warren', 'Y', 'Warren', 'OH', 'Y', 'America/New_York', @NODE_ID, GETDATE(), GETDATE(), 'SYSTEM', 
	'', 'Y', 'Y', 'City of Warren, OH', 'SYSTEM', 3, 30, 30)
GO

--- INSERT MERCHANT INFORMATION ---
DECLARE @SITE_ID AS INT = (SELECT TOP 1 ID FROM ECOMM_SITE WHERE NAME = 'WARREN')
