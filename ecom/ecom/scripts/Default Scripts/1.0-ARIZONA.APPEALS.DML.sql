------------*************************Arizona Court Of Appeals Division One SPECIFIC SCRIPTS *******************************************---------------
...
VALUES ('APPEALS', 'Arizona Court Of Appeals Division One', 'Y', 'Phoenix', 'AZ', 'Y', 'America/Los_Angeles', @NODE_ID, GETDATE(), GETDATE(), 'SYSTEM', 
	'', 'N', 'N', 'Arizona Court Of Appeals Division One', 'SYSTEM', 72, 30, 30)
GO

--- INSERT MERCHANT INFORMATION ---
DECLARE @SITE_ID AS INT = (SELECT TOP 1 ID FROM ECOMM_SITE WHERE NAME = 'APPEALS')
...
VALUES ('Arizona Court Of Appeals Division One - TERMS AND CONDITIONS', GETDATE(), GETDATE(), 'SYSTEM', @SITE_ID, @TERM_TYPE_ID, 'Y', 'SYSTEM')
GO
...
INSERT INTO ECOMM_BANK_DETAILS (SITE_ID, FROM_FNAME, FROM_LNAME, FROM_MINITIAL, FROM_ADDRLINE1, FROM_ADDRLINE2, FROM_CITY, FROM_STATE, FROM_ZIPCODE, FROM_PHONENUM,
						...
						VALUES (@SITE_ID, 'AMCAD', '', '','15867 N Mountain Road','','Broadway','VA','22815','','BB&T','111-20/121','056005318','0005132069613', 90000, 90000, 99999,  
...
VALUES (@SITE_ID, 'Web Payments/APPEALS/', 'webmaster@aoc.org', 'Payment Confirmation - Roam Appeals Court Records', 
	'Subscription Change Notification - Roam Appeals Court Records', 'Cancelled Subscription Notification - Roam Appeals Court Records', 
	'Subscription Reactivated - Roam Appeals Court Records', 'Recurring Payment Posted Successfully - Roam Appeals Court Records', 
	'Recurring Payment Failed - Roam Appeals Court Records',
	...
	'recurringPaymentUnsuccessfulTemplate.stl', GETDATE(), GETDATE(), 'SYSTEM', 'Y', 'Web Purchase Confirmation - Roam Appeals Court Records', 'webPaymentConfirmation.stl', 
	'Subscription Removed - Roam Appeals Court Records', 'removeSubscription.stl', 'SYSTEM', 'Access Authorization - Roam Appeals Court Records', 'accessAuthorization.stl')
GO