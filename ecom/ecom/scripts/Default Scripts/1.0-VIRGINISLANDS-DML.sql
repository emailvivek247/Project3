...
INSERT INTO ECOMM_SITE (NAME, DESCRIPTION, ACTIVE, COUNTY, STATE, AUTOACTIVATE, TIMEZONE, NODE_ID, DATE_TIME_CREATED, DATE_TIME_MOD, 
	MOD_USER_ID, SUBSCRIPTION_VALIDATION_TEXT, ENABLE_MICRO_TX_OTC, ENABLE_MICRO_TX_WEB, NAME_ON_CHECK, CREATED_BY, CHECK_HOLD_PERIOD, ACH_HOLD_PERIOD, SEARCH_DAY_THRESHOLD, USER_RETENTION_DAYS)
VALUES ('VIRGINISLANDS', 'Virgin Islands', 'Y', 'Virgin Islands', 'VI', 'Y', 'Atlantic/Bermuda', @NODE_ID, GETDATE(), GETDATE(), 'SYSTEM', 
	'', 'Y', 'Y', 'Government of the Virgin Islands', 'SYSTEM', 3, 3, 30, 30)
GO

--- INSERT MERCHANT INFORMATION ---
DECLARE @SITE_ID AS INT = (SELECT TOP 1 ID FROM ECOMM_SITE WHERE NAME = 'VIRGINISLANDS')
...
VALUES ('WARREN - TERMS AND CONDITIONS', GETDATE(), GETDATE(), 'SYSTEM', @SITE_ID, @TERM_TYPE_ID, 'Y', 'SYSTEM')
GO
...
(@SITE_ID, '', '', '', '', '','','','','','WEB',GETDATE(), GETDATE(), 'SYSTEM','Y', 'SYSTEM')
GO
