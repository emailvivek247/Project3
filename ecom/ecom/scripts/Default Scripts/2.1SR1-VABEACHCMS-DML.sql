...
VALUES (@SITE_ID, 'CaseManagement/vabeachcms/', 'noReply@amcad.com', 'Payment Confirmation - Roam Virginia Beach Court Records', 
	'Subscription Change Notification - Roam Virginia Beach Court Records', 'Cancelled Subscription Notification - Roam Virginia Beach Court Records', 
	'Subscription Reactivated - Roam Virginia Beach Court Records', 'Recurring Payment Posted Successfully - Roam Virginia Beach Court Records', 
	'Recurring Payment Failed - Roam Virginia Beach Court Records',
	...
	'recurringPaymentUnsuccessfulTemplate.stl', GETDATE(), GETDATE(), 'SYSTEM', 'Y', 'Web Purchase Confirmation - Roam Virginia Beach Court Records', 
	'webPaymentConfirmation.stl', 'Subscription Removed - Roam Virginia Beach Court Records','removeSubscription.stl', 'SYSTEM', 
	'Access Authorization - Roam Virginia Beach Court Records', 'accessAuthorization.stl')
GO
...
VALUES ('VABEACHCMS_ADMIN', 'Virginia Beach ROAM ADMIN', GETDATE(), GETDATE(), 'SYSTEM', 'N', 'Y', 'ACCESS TO THE ROAM DESKTOP.', 'N', NULL, 'SYSTEM', 'N')
INSERT INTO AUTH_ACCESS (ACCESS_CD, ACCESS_DESCR, DATE_TIME_CREATED, DATE_TIME_MOD, MOD_USER_ID, GUEST_FLG, ACTIVE, ACCESS_FEATURES, DEFAULT_ACCESS_FLG, ACCESS_ORDER, CREATED_BY, IS_AUTHORIZATION_REQUIRED)
VALUES ('VABEACHCMS_IMAGE_ACCESS', 'Unlimited Image Access', GETDATE(), GETDATE(), 'SYSTEM', 'N', 'Y', 'Access to Virginia Beach Land Record along with Image access. The subscription fee is $75 per month until cancelled, but non refundable for the paid subscription period.', 'Y', '1', 'SYSTEM', 'Y')
GO
...
INSERT INTO ECOMM_BANK_DETAILS (SITE_ID, FROM_FNAME, FROM_LNAME, FROM_MINITIAL, FROM_ADDRLINE1, FROM_ADDRLINE2, FROM_CITY, FROM_STATE, FROM_ZIPCODE, FROM_PHONENUM,
						...
						VALUES (@SITE_ID, 'AMCAD', '', '','15867 N Mountain Road','','Broadway','VA','22815','','BB&T','111-20/121','056005318','0005132069613', 170000, 170000, 179999,
