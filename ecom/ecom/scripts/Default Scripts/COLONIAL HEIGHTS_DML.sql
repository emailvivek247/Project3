...
VALUES ('COLONIALHEIGHTS', 'City of Colonial Heights', 'Y', 'Colonial Heights', 'VA', 'Y', 'America/New_York', @NODE_ID, GETDATE(), GETDATE(), 'SYSTEM', 
	'You can choose only one of the available subscriptions of a particular type for Colonial Heights.', 'Y', 'Y', 'City of Colonial Heights', 'SYSTEM', 3, 30, 30)
GO

--- INSERT SITE CONFIGURATION INFORMATION ---
DECLARE @SITE_ID AS INT = (SELECT TOP 1 ID FROM ECOMM_SITE WHERE NAME = 'COLONIALHEIGHTS')
...
VALUES (@SITE_ID, 'Records Management/COLONIALHEIGHTS/', 'noReply@amcad.com', 'Payment Confirmation - Roam Colonial Heights Records Management', 
	'Subscription Change Notification - Roam Colonial Heights Records Management', 'Cancelled Subscription Notification - Roam Colonial Heights Records Management', 
	'Subscription Reactivated - Roam Colonial Heights Records Management', 'Recurring Payment Posted Successfully - Roam Colonial Heights Records Management', 
	'Recurring Payment Failed - Roam Colonial Heights Records Management',
	...
	'recurringPaymentUnsuccessfulTemplate.stl', GETDATE(), GETDATE(), 'SYSTEM', 'Y', 'Web Purchase Confirmation - Roam Colonial Heights Records Management', 
	'webPaymentConfirmation.stl', 'Subscription Removed - Roam Colonial Heights Records Management','removeSubscription.stl', 'SYSTEM', 
	'Access Authorization - Roam Colonial Heights Records Management', 'accessAuthorization.stl')
GO
...
VALUES (@SITE_ID, 'vpratti', '239C4BED958C2527627816CD4CE18E8FE3EF87334EAF57A9AA5A5657F8239258', 'amcadepay', 'Y', 'paypal', GETDATE(), GETDATE(), 'SYSTEM', 'N', 'SYSTEM', '2.20','0.30','3.50','0.00')
GO

DECLARE @SITE_ID AS INT = (SELECT TOP 1 ID FROM ECOMM_SITE WHERE NAME = 'COLONIALHEIGHTS')
INSERT INTO ECOMM_MERCHANTINFO (SITE_ID, USERNAME, PASSWORD, VENDORNAME, ACTIVE, PARTNER, DATE_TIME_CREATED, DATE_TIME_MOD, MOD_USER_ID, IS_MICROPAYMENT_ACCOUNT, CREATED_BY, TRAN_FEE_PERCENTAGE, TRAN_FEE_FLAT, TRAN_FEE_PERCENTAGE_AMEX, TRAN_FEE_FLAT_AMEX)
VALUES (@SITE_ID, 'vpratti', '239C4BED958C2527627816CD4CE18E8FE3EF87334EAF57A9AA5A5657F8239258', 'amcadepay', 'Y', 'paypal', GETDATE(), GETDATE(), 'SYSTEM', 'Y', 'SYSTEM', '2.20','0.30','3.50','0.00')
GO
...
VALUES ('<b>Terms and Conditions</b><br /><br /><ol><li><u>Access to and use of the City of Colonial Heights Clerk of the Circuit Court Services (hereinafter "Services") provided by the City of Colonial Heights Clerk of the Circuit Court is subject to the terms and conditions of this User Agreement and all applicable laws and regulations. </u>This includes the laws and regulations governing copyright, trademark and other intellectual property as it may pertain to the property licensed to the City by AMCAD. For the purposes of this User Agreement, the Register of Deeds of the City of Colonial Heights Clerk of the Circuit Court shall be referred to as the "City", and you, the User, will be referred to as "You" (including the possessive "Your"), and the "User". </li><li><u>By reading this document and accessing the services, you accept without limitation or qualification, all of the terms and conditions in this user agreement.</u> You agree that your acceptance obligates you to pay for access to these Services. This includes an obligation to pay the charges incurred by third parties, whether they are your agents or otherwise, who access this Service through Your account. The City reserves the right to change these terms and conditions and the prices charged for Services at any time. Changes to the terms of this Agreement and charges for Services will only apply to future uses of the Services (i.e. a change to the charge for an individual image will apply to charges occurring after the change, while a change to the charge for subscription access will apply to the next billing cycle following the change.) Your continued use of this Site and these Services after the posting of updates to this Agreement, or the charges for Services will constitute your agreement to those terms or charges, as modified. The City additionally reserves the right to modify or discontinue, at any time, any Services, without notice or liability.<br /> <br /><u>LIABILITY FOR CHARGES INCURRED FOR ACCESS TO SERVICES.</u> By checking the "I agree to the  Terms of Use" box and accessing the Services, you agree to pay the charges established for these Services. The current charges applicable to the use of these Services can be seen by clicking on the Subscription menu. </li><li><u>OWNERSHIP AND PROPRIETARY RIGHTS.</u> All of the products and Services, including but not limited to text, data, maps, images, graphics, trademarks, logos and service marks (collectively, the "Content"), are owned by the City or licensed to the City by AMCAD, the owner of the Content. Although the City does not claim a copyright, trademark or other intellectual property interest in the Content, AMCAD reserves their copyright, trademark or other intellectual property interests in their property that is part of the Content. In connection with those products and Services, you agree to the following: text, data, maps, images, graphics, , trademarks, logos and service marks (collectively, the "Content"), are owned by the City or licensed to the City by third-parties who own the Content and the third party licensors'' property interests are protected by copyright, trademark and other intellectual property laws. In connection with those products and Services, you agree to the following: <ul><li>When accessing the Content, you may print a copy. If a printout and/or download is made, applicable third parties shall retain all rights in this material, and such a printout and/or download shall retain any copyright or other notices contained in that Content.</li><li>You will abide by restrictions set forth on the Site with respect to any of the Content. </li><li>You will not in any way violate the intellectual property laws protecting the third party licensors'' property interests in the Content. </li><li>You will not reuse, republish or otherwise distribute the Content or any modified or altered versions of it, whether over the Internet or otherwise, and whether or not for payment, without the express written permission of the copyright holder. </li><li>You will cooperate promptly and completely with any reasonable request by the City related to an investigation of infringement of copyright or other proprietary right of the third party licensor. </li><li>You agree that the material you are accessing contains the trade secrets and intellectual property of AMCAD, and you will cause irreparable harm to AMCAD if this material is used in violation of this agreement. </li></ul><li><u>INDEMNIFICATION:</u> You hereby agree to indemnify and hold harmless the City, and its respective officials, agencies, officers, subsidiaries, employees, licensors and agents, from and against any and all liability, loss, claims, damages, costs and/or actions (including attorneys'' fees) based upon or arising out of any breach by you or any third party of the obligations under this Agreement. Notwithstanding your indemnification obligation, the City reserves the right to defend any such claim and you agree to provide us with such reasonable cooperation and information as we may request. <br /> <br /><u>DISCLAIMER OF WARRANTY AND LIMITATION OF LIABILITY:</u> The City of Colonial Heights Clerk of the Circuit Court makes every effort to update this information on a daily basis. Because Property information is continually changing, City of Colonial Heights Clerk of the Circuit Court makes no expressed or implied warranty concerning the accuracy of this information.<ul><li>The information and services and products available to you may contain errors and are subject to periods of interruption. The City will do its best to maintain the information and services it offers. You agree that all use of these services is at your own risk, and that the City will not be held liable for any errors or omissions contained in the content of its services.<br /><br />The services are provided "as is" and the City expressly disclaims any and all warranties, express and implied, including but not limited to any warranties of accuracy, reliability, title, merchantability, non- infringement, fitness for a particular purpose or any other warranty, condition, guarantee or representation whether oral, in writing or in electronic form, including but not limited to the accuracy or completeness of any information contained therein or provided by the services. The City does not represent or warrant that access to the service will be interrupted or that there will be no failures, errors or omissions or loss of transmitted information. The information, documents and related graphics published on this server could include technical inaccuracies or typographical errors. Changes are periodically made to the information herein. The City may make improvements and/or changes in the services provided and/or the content described herein at any time.<br /><br />This disclaimer of liability applies to any damages or injury caused by any failure of performance error, omission, interruption, deletion, defect, delay in operation or transmission, computer viruses, communication line failure, theft or destruction or unauthorized access to alteration of or use of record, whether for breach of contract, tortious behavior, negligence or any other cause of action. No advice or information, whether oral or written, obtained by you from the City or through or from the service shall create any warranty not expressly stated in this agreement. If you are dissatisfied with the service, or any portion thereof, your exclusive remedy shall be to stop using the service.</li><li><u>MISCELLANEOUS:</u> The City has the right at any time to change or discontinue any aspect or feature of the services, including, but not limited to, content, hours of availability, and equipment needed for access or use. You must use the services for lawful purposes only. <br /><br />Any user conduct that restricts or inhibits any other person from using or enjoying the services will not be permitted. Uses such as data mining, screen scraping and the use of electronic BOTS for image download are prohibited. Users that are found to be employing the previously mentioned electronic methods may be restricted on this website. <br /><br />These terms and conditions shall be governed by and construed according to the laws of the Commonwealth of Virginia, USA. and you agree to submit to the personal jurisdiction of the courts of the City of Colonial Heights Clerk of the Circuit Court, Commonwealth of Virginia. If any portion of these terms and conditions is deemed by a court to be invalid, the remaining provisions shall remain in full force and effect. You agree that regardless of any statute or law to the contrary, and claim or cause of action arising out of or related to the use of these services, must be filed within one year after such claim or cause of action arose.<br /><br />This is an offer to provide Services, and acceptance is expressly conditioned upon your acceptance of these terms and only these terms. Your acceptance of this Agreement is demonstrated by checking the box of "I agree to the Terms of Use" in the Registration form. This Agreement represents the entire agreement between you (the user) and the City. </li> </ul></li></ol>',
...
VALUES ('COLONIALHEIGHTS_ADMIN', 'Colonial Heights ROAM ADMIN', GETDATE(), GETDATE(), 'SYSTEM', 'N', 'Y', 'ACCESS TO THE ROAM DESKTOP.', 'N', NULL, 'SYSTEM', 'N')
INSERT INTO AUTH_ACCESS (ACCESS_CD, ACCESS_DESCR, DATE_TIME_CREATED, DATE_TIME_MOD, MOD_USER_ID, GUEST_FLG, ACTIVE, ACCESS_FEATURES, DEFAULT_ACCESS_FLG, ACCESS_ORDER, CREATED_BY, IS_AUTHORIZATION_REQUIRED)
VALUES ('COLONIALHEIGHTS_IMAGE_ACCESS', 'Colonial Heights Image Access', GETDATE(), GETDATE(), 'SYSTEM', 'N', 'Y', 'Access to Colonial Heights Land Record along with Image access. The subscription fee is $50 per month until cancelled, but non refundable for the paid subscription period.', 'Y', '1', 'SYSTEM', 'Y')
INSERT INTO AUTH_ACCESS (ACCESS_CD, ACCESS_DESCR, DATE_TIME_CREATED, DATE_TIME_MOD, MOD_USER_ID, GUEST_FLG, ACTIVE, ACCESS_FEATURES, DEFAULT_ACCESS_FLG, ACCESS_ORDER, CREATED_BY, IS_AUTHORIZATION_REQUIRED)
VALUES ('COLONIALHEIGHTS_FREE_ACCESS', 'Colonial Heights Free Access', GETDATE(), GETDATE(), 'SYSTEM', 'N', 'Y', 'Access to Colonial Heights Records Management. This does not include access to the images. Please choose the Premium subscription to get access to the images.', 'N', '2', 'SYSTEM', 'N')
GO

--- INSERT SITE ACCESS INFORMATION ---
DECLARE @SITE_ID AS INT = (SELECT TOP 1 ID FROM ECOMM_SITE WHERE NAME = 'COLONIALHEIGHTS')
DECLARE @ACCESS_ID AS INT = (SELECT TOP 1 ID FROM AUTH_ACCESS WHERE ACCESS_CD = 'COLONIALHEIGHTS_ADMIN')
...
SET @ACCESS_ID = (SELECT TOP 1 ID FROM AUTH_ACCESS WHERE ACCESS_CD = 'COLONIALHEIGHTS_IMAGE_ACCESS')
INSERT INTO ECOMM_SITE_ACCESS (SITE_ID, ACCESS_ID, DATE_TIME_CREATED, DATE_TIME_MOD, MOD_USER_ID, ACTIVE, CREATED_BY)
VALUES (@SITE_ID, @ACCESS_ID, GETDATE(), GETDATE(), 'SYSTEM', 'Y', 'SYSTEM')
SET @ACCESS_ID = (SELECT TOP 1 ID FROM AUTH_ACCESS WHERE ACCESS_CD = 'COLONIALHEIGHTS_FREE_ACCESS')
INSERT INTO ECOMM_SITE_ACCESS (SITE_ID, ACCESS_ID, DATE_TIME_CREATED, DATE_TIME_MOD, MOD_USER_ID, ACTIVE, CREATED_BY)
VALUES (@SITE_ID, @ACCESS_ID, GETDATE(), GETDATE(), 'SYSTEM', 'Y', 'SYSTEM')
GO
...
DECLARE @SITEACCESS_ID AS INT = (SELECT TOP 1 ID FROM ECOMM_SITE_ACCESS WHERE ACCESS_ID = (SELECT TOP 1 ID FROM AUTH_ACCESS WHERE ACCESS_CD = 'COLONIALHEIGHTS_IMAGE_ACCESS'))
...
SET @SITEACCESS_ID = (SELECT TOP 1 ID FROM ECOMM_SITE_ACCESS WHERE ACCESS_ID = (SELECT TOP 1 ID FROM AUTH_ACCESS WHERE ACCESS_CD = 'COLONIALHEIGHTS_FREE_ACCESS'))
INSERT INTO ECOMM_SUBSCRIPTIONFEE (SUBSCRIPTION_TYP_ID, SITEACCESS_ID, FEE, TERM, CURRENCY, ACTIVE, DATE_TIME_CREATED, DATE_TIME_MOD, MOD_USER_ID, CREATED_BY)
...
INSERT INTO ECOMM_BANK_DETAILS (SITE_ID, FROM_FNAME, FROM_LNAME, FROM_MINITIAL, FROM_ADDRLINE1, FROM_ADDRLINE2, FROM_CITY, FROM_STATE, FROM_ZIPCODE, FROM_PHONENUM,
						...
						VALUES (@SITE_ID, 'AMCAD', '', '','15867 N Mountain Road','','Broadway','VA','22815','','Capital Bank','65-334/550','055003340','111989111', 90000, 90000, 99999,
...
INSERT INTO AUTH_USERS (EMAIL_ID, PASSWORD, FIRST_NAME, LAST_NAME, DATE_TIME_CREATED, DATE_TIME_MOD, MOD_USER_ID, ADDRESS_1, ADDRESS_2, CITY, STATE, ZIP, PHONE, CREATED_IP, 
				...
				VALUES ('coloniaheightsadmin@roam.com', '2851FFD2E30E91904A9E86F326E442065D75DB65A028854E9A5ACEE67E53EA59', 'ROAM', 'ADMIN', GETDATE(), GETDATE(), 'ADMIN', null, null, null, null, null, null, '1.1.1.1.1', 
						'Y', 'Y', 'Y', 'Y', GETDATE(), 'RECORDSMANAGEMENT', GETDATE(), 'SYSTEM')
DECLARE @ACCESS_ID AS INT = (SELECT TOP 1 ID FROM AUTH_ACCESS WHERE ACCESS_CD = 'COLONIALHEIGHTS_ADMIN')
DECLARE @USER_ID AS INT = (SELECT TOP 1 ID FROM AUTH_USERS WHERE EMAIL_ID = 'coloniaheightsadmin@roam.com')
...
VALUES (@SITE_ID, 'Colonial Heights Circuit Court Clerks Office', '2425 Nimmo Parkway', 'Build 10-B', 'Colonial Heights', 'VA','23456','7573858821','','','OTC',GETDATE(), GETDATE(), 'SYSTEM','Y', 'SYSTEM')
GO

--- INSERT PROFIT SHARE ---
DECLARE @ACCESS_ID AS INT = (SELECT TOP 1 ID FROM AUTH_ACCESS WHERE ACCESS_CD = 'COLONIALHEIGHTS_IMAGE_ACCESS')
