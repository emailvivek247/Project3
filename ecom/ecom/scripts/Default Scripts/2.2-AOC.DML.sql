...
MOD_USER_ID, SUBSCRIPTION_VALIDATION_TEXT, ENABLE_MICRO_TX_OTC, ENABLE_MICRO_TX_WEB, NAME_ON_CHECK, CREATED_BY, CHECK_HOLD_PERIOD, SEARCH_DAY_THRESHOLD, USER_RETENTION_DAYS, IS_FIRM_NUMBER_REQUIRED, IS_BAR_NUMBER_REQUIRED, IS_FREE_SITE)
	VALUES ('AOC', 'Arizona eAccess', 'Y', '', 'AZ', 'Y', 'America/Phoenix', @NODE_ID, GETDATE(), GETDATE(), 'SYSTEM', 'You can choose only one of the available subscriptions', 'Y', 'Y', 'Arizona Administrative Office of the Courts', 'SYSTEM', 3, 30, 30, 'Y', 'N', 'N')
GO
...
REMOVE_SUBSCRIPTION_TEMPLATE, CREATED_BY, ACCESS_AUTHORIZATION_SUB, ACCESS_AUTHORIZATION_TEMPLATE, PAYASUGO_PAYMENT_CONFIRMATION_SUB, PAYASUGO_PAYMENT_CONFIRMATION_TEMPLATE, ADD_SUBSCRIPTION_SUB)
	VALUES (@SITE_ID, 'CaseManagement/aoc/', 'noReplyTest@amcad.com', 'Payment Confirmation - Roam Arizona Court Records', 'Subscription Change Notification - Roam Arizona Court Records', 'Cancelled Subscription Notification - Roam Arizona Court Records', 'Subscription Reactivated - Roam Arizona Court Records', 'Recurring Payment Posted Successfully - Roam Arizona Court Records', 'Recurring Payment Failed - Roam Arizona Court Records', 'paymentConfirmation.stl', 'changeConfirmation.stl', 'cancelConfirmation.stl', 'cancelConfirmation.stl', 'recurringPaymentSuccessfulTemplate.stl', 'recurringPaymentUnsuccessfulTemplate.stl', GETDATE(), GETDATE(), 'SYSTEM', 'Y', 'Web Purchase Confirmation - Roam Arizona Court Records', 'webPaymentConfirmation.stl', 'Subscription Removed - Roam Arizona Court Records', 'removeSubscription.stl', 'SYSTEM', 'Access Authorization - Roam Arizona Court Records', 'accessAuthorization.stl', 'Pay As You Go Purchase Confirmation - ROAM Arizona Case Management', 'payAsYouGoPaymentConfirmation.stl', 'Subscription Add Notification - Arizona eAccess Case Management')
GO
...
GO
INSERT INTO AUTH_ACCESS (ACCESS_CD, ACCESS_DESCR, DATE_TIME_CREATED, DATE_TIME_MOD, MOD_USER_ID, GUEST_FLG, ACTIVE, ACCESS_FEATURES, DEFAULT_ACCESS_FLG, ACCESS_ORDER, CREATED_BY, IS_AUTHORIZATION_REQUIRED, IS_FIRM_LEVEL_ACCESS, MAX_USERS_ALLOWED, MAX_DOCUMENTS_ALLOWED, IS_VISIBLE)
	VALUES ('AOC_CERTIFIED_ACCESS', 'AOC Certified Access to Court Case Documents', GETDATE(), GETDATE(), 'SYSTEM', 'N', 'Y', 'Provides certified access to Arizona Court Case Records.', 'N', '9', 'SYSTEM', 'N', 'Y', 0, 0, 'N')
Go
...
VALUES ('CERT', 'Certified Document Access', 'Y', GETDATE(), GETDATE(), 'APATEL', 'CERTIFIED_NON_RECURRING_SUBSCRIPTION', 'APATEL')
GO
...
WHERE NAME = 'AOC' AND DESCRIPTION = 'Arizona eAccess'
GO
...
FROM AUTH_ACCESS
WHERE ACCESS_CD = 'AOC_CERTIFIED_ACCESS'))
UPDATE ECOMM_SUBSCRIPTIONFEE set SUBSCRIPTION_TYP_ID = @SUBSCRIPTION_TYP_ID where SITEACCESS_ID = @SITEACCESS_ID
GO
...
-- Insert Master Data in Location Table
DECLARE @SITE_ID AS INT = ( SELECT TOP 1
	ID
FROM ECOMM_SITE
WHERE NAME = 'AOC')
INSERT INTO ECOMM_LOCATION (LOCATION_NAME, STATE_CODE, SITE_ID, DATE_TIME_CREATED, DATE_TIME_MOD, MOD_USER_ID, CREATED_BY, ACTIVE) 
    VALUES (UPPER('Apache'), 'AZ', @SITE_ID, GETDATE(), GETDATE(), 'SYSTEM', 'SYSTEM', 'Y')

INSERT INTO ECOMM_LOCATION (LOCATION_NAME,  STATE_CODE, SITE_ID, DATE_TIME_CREATED, DATE_TIME_MOD, MOD_USER_ID, CREATED_BY, ACTIVE)
	VALUES (UPPER('Cochise'), 'AZ', @SITE_ID, GETDATE(), GETDATE(), 'SYSTEM', 'SYSTEM', 'Y')

INSERT INTO ECOMM_LOCATION (LOCATION_NAME,  STATE_CODE, SITE_ID, DATE_TIME_CREATED, DATE_TIME_MOD, MOD_USER_ID, CREATED_BY, ACTIVE)
	VALUES (UPPER('Coconino'), 'AZ', @SITE_ID, GETDATE(), GETDATE(), 'SYSTEM', 'SYSTEM', 'Y')

INSERT INTO ECOMM_LOCATION (LOCATION_NAME,  STATE_CODE, SITE_ID, DATE_TIME_CREATED, DATE_TIME_MOD, MOD_USER_ID, CREATED_BY, ACTIVE)
	VALUES (UPPER('Gila'),  'AZ', @SITE_ID, GETDATE(), GETDATE(), 'SYSTEM', 'SYSTEM', 'Y')

INSERT INTO ECOMM_LOCATION (LOCATION_NAME,  STATE_CODE, SITE_ID, DATE_TIME_CREATED, DATE_TIME_MOD, MOD_USER_ID, CREATED_BY, ACTIVE)
	VALUES (UPPER('Graham'), 'AZ', @SITE_ID, GETDATE(), GETDATE(), 'SYSTEM', 'SYSTEM', 'Y')

INSERT INTO ECOMM_LOCATION (LOCATION_NAME,  STATE_CODE, SITE_ID, DATE_TIME_CREATED, DATE_TIME_MOD, MOD_USER_ID, CREATED_BY, ACTIVE)
	VALUES (UPPER('Greenlee'), 'AZ', @SITE_ID, GETDATE(), GETDATE(), 'SYSTEM', 'SYSTEM', 'Y')

INSERT INTO ECOMM_LOCATION (LOCATION_NAME,  STATE_CODE, SITE_ID, DATE_TIME_CREATED, DATE_TIME_MOD, MOD_USER_ID, CREATED_BY, ACTIVE)
	VALUES (UPPER('La Paz'), 'AZ', @SITE_ID, GETDATE(), GETDATE(), 'SYSTEM', 'SYSTEM', 'Y')

INSERT INTO ECOMM_LOCATION (LOCATION_NAME,  STATE_CODE, SITE_ID, DATE_TIME_CREATED, DATE_TIME_MOD, MOD_USER_ID, CREATED_BY, ACTIVE)
	VALUES (UPPER('Maricopa'), 'AZ', @SITE_ID, GETDATE(), GETDATE(), 'SYSTEM', 'SYSTEM', 'Y')

INSERT INTO ECOMM_LOCATION (LOCATION_NAME,  STATE_CODE, SITE_ID, DATE_TIME_CREATED, DATE_TIME_MOD, MOD_USER_ID, CREATED_BY, ACTIVE)
	VALUES (UPPER('Mohave'), 'AZ', @SITE_ID, GETDATE(), GETDATE(), 'SYSTEM', 'SYSTEM', 'Y')

INSERT INTO ECOMM_LOCATION (LOCATION_NAME,  STATE_CODE, SITE_ID, DATE_TIME_CREATED, DATE_TIME_MOD, MOD_USER_ID, CREATED_BY, ACTIVE)
	VALUES (UPPER('Navajo'), 'AZ', @SITE_ID, GETDATE(), GETDATE(), 'SYSTEM', 'SYSTEM', 'Y')

INSERT INTO ECOMM_LOCATION (LOCATION_NAME,  STATE_CODE, SITE_ID, DATE_TIME_CREATED, DATE_TIME_MOD, MOD_USER_ID, CREATED_BY, ACTIVE)
	VALUES (UPPER('Pima'), 'AZ', @SITE_ID, GETDATE(), GETDATE(), 'SYSTEM', 'SYSTEM', 'Y')

INSERT INTO ECOMM_LOCATION (LOCATION_NAME,  STATE_CODE, SITE_ID, DATE_TIME_CREATED, DATE_TIME_MOD, MOD_USER_ID, CREATED_BY, ACTIVE)
	VALUES (UPPER('Pinal'), 'AZ', @SITE_ID, GETDATE(), GETDATE(), 'SYSTEM', 'SYSTEM', 'Y')

INSERT INTO ECOMM_LOCATION (LOCATION_NAME,  STATE_CODE, SITE_ID, DATE_TIME_CREATED, DATE_TIME_MOD, MOD_USER_ID, CREATED_BY, ACTIVE)
	VALUES (UPPER('Santa Cruz'), 'AZ', @SITE_ID, GETDATE(), GETDATE(), 'SYSTEM', 'SYSTEM', 'Y')

INSERT INTO ECOMM_LOCATION (LOCATION_NAME,  STATE_CODE, SITE_ID, DATE_TIME_CREATED, DATE_TIME_MOD, MOD_USER_ID, CREATED_BY, ACTIVE)
	VALUES (UPPER('Yavapai'), 'AZ', @SITE_ID, GETDATE(), GETDATE(), 'SYSTEM', 'SYSTEM', 'Y')

INSERT INTO ECOMM_LOCATION (LOCATION_NAME,  STATE_CODE, SITE_ID, DATE_TIME_CREATED, DATE_TIME_MOD, MOD_USER_ID, CREATED_BY, ACTIVE)
	VALUES (UPPER('Yuma'), 'AZ', @SITE_ID, GETDATE(), GETDATE(), 'SYSTEM', 'SYSTEM', 'Y')
GO



-- Update the Location codes with values
DECLARE @SITE_ID AS INT = ( SELECT TOP 1
	ID
FROM ECOMM_SITE
WHERE NAME = 'AOC')
UPDATE ECOMM_LOCATION SET LOCATION_CODE = 'APCH' WHERE LOCATION_NAME = 'APACHE' AND SITE_ID = @SITE_ID
UPDATE ECOMM_LOCATION SET LOCATION_CODE = 'CCHS' WHERE LOCATION_NAME = 'COCHISE' AND SITE_ID = @SITE_ID
UPDATE ECOMM_LOCATION SET LOCATION_CODE = 'CCN' WHERE LOCATION_NAME = 'Coconino' AND SITE_ID = @SITE_ID
UPDATE ECOMM_LOCATION SET LOCATION_CODE = 'GLA' WHERE LOCATION_NAME = 'Gila' AND SITE_ID = @SITE_ID
UPDATE ECOMM_LOCATION SET LOCATION_CODE = 'GRM' WHERE LOCATION_NAME = 'Graham' AND SITE_ID = @SITE_ID
UPDATE ECOMM_LOCATION SET LOCATION_CODE = 'GRLE' WHERE LOCATION_NAME = 'Greenlee' AND SITE_ID = @SITE_ID
UPDATE ECOMM_LOCATION SET LOCATION_CODE = 'LPAZ' WHERE LOCATION_NAME = 'La Paz' AND SITE_ID = @SITE_ID
UPDATE ECOMM_LOCATION SET LOCATION_CODE = 'MRCP' WHERE LOCATION_NAME = 'Maricopa' AND SITE_ID = @SITE_ID
UPDATE ECOMM_LOCATION SET LOCATION_CODE = 'MHV' WHERE LOCATION_NAME = 'Mohave' AND SITE_ID = @SITE_ID
UPDATE ECOMM_LOCATION SET LOCATION_CODE = 'NVJ' WHERE LOCATION_NAME = 'Navajo' AND SITE_ID = @SITE_ID
UPDATE ECOMM_LOCATION SET LOCATION_CODE = 'PMA' WHERE LOCATION_NAME = 'Pima' AND SITE_ID = @SITE_ID
UPDATE ECOMM_LOCATION SET LOCATION_CODE = 'PNL' WHERE LOCATION_NAME = 'Pinal' AND SITE_ID = @SITE_ID
UPDATE ECOMM_LOCATION SET LOCATION_CODE = 'SNCRZ' WHERE LOCATION_NAME = 'Santa Cruz' AND SITE_ID = @SITE_ID
UPDATE ECOMM_LOCATION SET LOCATION_CODE = 'YVP' WHERE LOCATION_NAME = 'Yavapai' AND SITE_ID = @SITE_ID
UPDATE ECOMM_LOCATION SET LOCATION_CODE = 'YMA' WHERE LOCATION_NAME = 'Yuma' AND SITE_ID = @SITE_ID
GO

ALTER TABLE ECOMM_LOCATION ALTER COLUMN LOCATION_CODE VARCHAR(10) NOT NULL
GO

EXEC SP_RENAME 'ECOMM_LOCATION.LOCATION_NAME', 'DESCRIPTION', 'COLUMN'
GO

EXEC SP_RENAME 'ECOMM_LOCATION.STATE_CODE', 'STATE_DESCRIPTION', 'COLUMN'
GO

ALTER TABLE ECOMM_LOCATION ALTER COLUMN STATE_DESCRIPTION VARCHAR(40)
GO

UPDATE SITE_CONFIGURATION
SET ADD_SUBSCRIPTION_SUB = 'Subscription Add Notification - Roam Arizona Court Records'
WHERE EMAIL_TEMPLATE_FOLDER = 'CaseManagement/aoc/'
GO
