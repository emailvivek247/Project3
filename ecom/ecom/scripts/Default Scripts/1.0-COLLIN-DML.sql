...
VALUES ('COLLIN', 'Collin County', 'Y', 'Collin', 'TX', 'Y', 'America/New_York', @NODE_ID, GETDATE(), GETDATE(), 'SYSTEM', 
	'You can choose only one of the available subscriptions for Collin County.', 'Y', 'Y', 'Collin County', 'SYSTEM', 72, 30, 30, 72)
GO

--- INSERT SITE CONFIGURATION INFORMATION ---
DECLARE @SITE_ID AS INT = (SELECT TOP 1 ID FROM ECOMM_SITE WHERE NAME = 'COLLIN')
...
VALUES (@SITE_ID, 'Records Management/COLLIN/', 'noReply@amcad.com', 'Payment Confirmation - Roam Collin Records Management', 
	'Subscription Change Notification - Roam Collin Records Management', 'Cancelled Subscription Notification - Roam Collin Records Management', 
	'Subscription Reactivated - Roam Collin Records Management', 'Recurring Payment Posted Successfully - Roam Collin Records Management', 
	'Recurring Payment Failed - Roam Collin Records Management',
	...
	'recurringPaymentUnsuccessfulTemplate.stl', GETDATE(), GETDATE(), 'SYSTEM', 'Y', 'Web Purchase Confirmation - Roam Collin Records Management', 
	'webPaymentConfirmation.stl', 'Subscription Removed - Roam Collin Records Management','removeSubscription.stl', 'SYSTEM', 
	'Access Authorization - Roam Collin Records Management', 'accessAuthorization.stl')
GO
...
VALUES ('COLLIN_ADMIN', 'Collin County ROAM ADMIN', GETDATE(), GETDATE(), 'SYSTEM', 'N', 'Y', 'ACCESS TO THE ROAM DESKTOP.', 'N', NULL, 'SYSTEM', 'N')
INSERT INTO AUTH_ACCESS (ACCESS_CD, ACCESS_DESCR, DATE_TIME_CREATED, DATE_TIME_MOD, MOD_USER_ID, GUEST_FLG, ACTIVE, ACCESS_FEATURES, DEFAULT_ACCESS_FLG, ACCESS_ORDER, CREATED_BY, IS_AUTHORIZATION_REQUIRED)
VALUES ('COLLIN_PREMIUM_ACCESS', 'Collin County Premium Subscription', GETDATE(), GETDATE(), 'SYSTEM', 'N', 'Y', '<br />Subscription Cost: $250<br />Unlimited searches<br />Available Records: Sovereignty - Present<br />Unlimited Document Access<br />Unlimited Document Saving<br />Unlimited Document Printing<br />No Document Watermark<br />Max Results Per Page: 500<br />Additional Features: Full Field Text Searching, Faceting, Smart Navigation, User Defined Search Sorting, Shopping Cart Functionality<br />Premium Features: Phonetic Name Searching, Dashboards,Mobile Device Template, Document Chaining<br /><br />Requirements:<br /><br />1. Firm must have an Active Account for the Subscription Type.<br />2. Additional User Email Domain must match Email Domain of Firm Account.<br />3. Generic Email Domains (GMAIL, HOTMAIL, etc) are not accepted.<br />4. Account requires Authorization by County before Activation.', 'Y', '1', 'SYSTEM', 'N')
INSERT INTO AUTH_ACCESS (ACCESS_CD, ACCESS_DESCR, DATE_TIME_CREATED, DATE_TIME_MOD, MOD_USER_ID, GUEST_FLG, ACTIVE, ACCESS_FEATURES, DEFAULT_ACCESS_FLG, ACCESS_ORDER, CREATED_BY, IS_AUTHORIZATION_REQUIRED)
VALUES ('COLLIN_IMG_PREVIEW', 'Monthly Preview Subscription (Full Document Preview With Watermark)', GETDATE(), GETDATE(), 'SYSTEM', 'N', 'Y', '<br />Subscription Cost: $100<br />Unlimited searches<br />Available Records:1963 - Present<br />Full Document Preview w/ Watermark<br />Unlimited Document Saving<br />$1 Per Page to Print + $.50 Per Page Convenience Fee<br />Max Results Per Page: 100<br />Additional Features: Full Field Text Searching, Faceting, Smart Navigation, User Defined Search Sorting, Shopping Cart Functionality', 'Y', '1', 'SYSTEM', 'N')
INSERT INTO AUTH_ACCESS (ACCESS_CD, ACCESS_DESCR, DATE_TIME_CREATED, DATE_TIME_MOD, MOD_USER_ID, GUEST_FLG, ACTIVE, ACCESS_FEATURES, DEFAULT_ACCESS_FLG, ACCESS_ORDER, CREATED_BY, IS_AUTHORIZATION_REQUIRED)
VALUES ('COLLIN_IMG_PREVIEW_ADDL', 'Monthly Preview Subscription (Full Document Preview With Watermark)', GETDATE(), GETDATE(), 'SYSTEM', 'N', 'Y', '<br />Subscription Cost: $100<br />Unlimited searches<br />Available Records:1963 - Present<br />Full Document Preview w/ Watermark<br />Unlimited Document Saving<br />$1 Per Page to Print + $.50 Per Page Convenience Fee<br />Max Results Per Page: 100<br />Additional Features: Full Field Text Searching, Faceting, Smart Navigation, User Defined Search Sorting, Shopping Cart Functionality<br /><br /><br />Requirements:<br /><br />1. Firm must have an Active Account for the Subscription Type.<br />2. Additional User Email Domain must match Email Domain of Firm Account.<br />3. Generic Email Domains (GMAIL, HOTMAIL, etc) are not accepted.<br />4. Account requires Authorization by County before Activation.', 'Y', '1', 'SYSTEM', 'N')
GO


--- INSERT SITE ACCESS INFORMATION ---
DECLARE @SITE_ID AS INT = (SELECT TOP 1 ID FROM ECOMM_SITE WHERE NAME = 'COLLIN')
DECLARE @ACCESS_ID AS INT = (SELECT TOP 1 ID FROM AUTH_ACCESS WHERE ACCESS_CD = 'COLLIN_ADMIN')
...
SET @ACCESS_ID = (SELECT TOP 1 ID FROM AUTH_ACCESS WHERE ACCESS_CD = 'COLLIN_PREMIUM_ACCESS')
INSERT INTO ECOMM_SITE_ACCESS (SITE_ID, ACCESS_ID, DATE_TIME_CREATED, DATE_TIME_MOD, MOD_USER_ID, ACTIVE, CREATED_BY)
VALUES (@SITE_ID, @ACCESS_ID, GETDATE(), GETDATE(), 'SYSTEM', 'Y', 'SYSTEM')
SET @ACCESS_ID = (SELECT TOP 1 ID FROM AUTH_ACCESS WHERE ACCESS_CD = 'COLLIN_FREE_ACCESS')
INSERT INTO ECOMM_SITE_ACCESS (SITE_ID, ACCESS_ID, DATE_TIME_CREATED, DATE_TIME_MOD, MOD_USER_ID, ACTIVE, CREATED_BY)
VALUES (@SITE_ID, @ACCESS_ID, GETDATE(), GETDATE(), 'SYSTEM', 'Y', 'SYSTEM')
GO
...
DECLARE @SITEACCESS_ID AS INT = (SELECT TOP 1 ID FROM ECOMM_SITE_ACCESS WHERE ACCESS_ID = (SELECT TOP 1 ID FROM AUTH_ACCESS WHERE ACCESS_CD = 'COLLIN_PREMIUM_ACCESS'))
...
VALUES (@SUBSCRIPTION_TYP_ID, @SITEACCESS_ID, '150.00', 0, 'USD', 'Y', GETDATE(), GETDATE(), 'SYSTEM', 'SYSTEM')
SET @SUBSCRIPTION_TYP_ID = (SELECT TOP 1 ID FROM CODELOOKUP WHERE CODE = 'FREE')
SET @SITEACCESS_ID = (SELECT TOP 1 ID FROM ECOMM_SITE_ACCESS WHERE ACCESS_ID = (SELECT TOP 1 ID FROM AUTH_ACCESS WHERE ACCESS_CD = 'COLLIN_FREE_ACCESS'))
INSERT INTO ECOMM_SUBSCRIPTIONFEE (SUBSCRIPTION_TYP_ID, SITEACCESS_ID, FEE, TERM, CURRENCY, ACTIVE, DATE_TIME_CREATED, DATE_TIME_MOD, MOD_USER_ID, CREATED_BY)
...
INSERT INTO ECOMM_BANK_DETAILS (SITE_ID, FROM_FNAME, FROM_LNAME, FROM_MINITIAL, FROM_ADDRLINE1, FROM_ADDRLINE2, FROM_CITY, FROM_STATE, FROM_ZIPCODE, FROM_PHONENUM,
						...
						VALUES (@SITE_ID, 'AMCAD', '', '','15867 N Mountain Road','','Broadway','VA','22815','','BB&T','111-20/121','056005318','0005132069613', 40000, 40000, 49999,
...
INSERT INTO AUTH_USERS (EMAIL_ID, PASSWORD, FIRST_NAME, LAST_NAME, DATE_TIME_CREATED, DATE_TIME_MOD, MOD_USER_ID, ADDRESS_1, ADDRESS_2, CITY, STATE, ZIP, PHONE, CREATED_IP, 
				...
				VALUES ('collinadmin@roam.com', '2851FFD2E30E91904A9E86F326E442065D75DB65A028854E9A5ACEE67E53EA59', 'ROAM', 'ADMIN', GETDATE(), GETDATE(), 'Admin', null, null, null, null, null, null, '1.1.1.1.1', 
						'Y', 'Y', 'Y', 'Y', GETDATE(), 'RECORDSMANAGEMENT', GETDATE(), 'SYSTEM')
DECLARE @ACCESS_ID AS INT = (SELECT TOP 1 ID FROM AUTH_ACCESS WHERE ACCESS_CD = 'COLLIN_ADMIN')
DECLARE @USER_ID AS INT  = (SELECT TOP 1 ID FROM AUTH_USERS WHERE EMAIL_ID = 'collinadmin@roam.com')
...
VALUES (@SITE_ID, 'Collin County Clerk''s Office', 'Collin County Administration Building', '2300 Bloomdale Rd., Suite 2104', 'McKinney', 'TX','75071','9728813025','','','OTC',GETDATE(), GETDATE(), 'SYSTEM','Y', 'SYSTEM')
GO

--- INSERT PROFIT SHARE ---
DECLARE @ACCESS_ID AS INT = (SELECT TOP 1 ID FROM AUTH_ACCESS WHERE ACCESS_CD = 'COLLIN_PREMIUM_ACCESS')
INSERT INTO ECOMM_PROFIT_SHARE (ACCESS_ID, CLIENT_SHARE, DATE_TIME_CREATED, DATE_TIME_MOD, MOD_USER_ID, ACTIVE, CREATED_BY)
            VALUES(@ACCESS_ID, 0.00, GETDATE(), GETDATE(), 'SYSTEM', 'Y', 'SYSTEM')