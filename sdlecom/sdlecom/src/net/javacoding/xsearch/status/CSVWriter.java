 ...
 * 
 * This format is mainly used my Microsoft Word and Excel. Fields are separated
 * by commas, and enclosed in quotes if they contain commas or quotes. Embedded
 ...
 * 
 * @author copyright (c) 2002 Roedy Green Canadian Mind Products Roedy posted
 *         this code on Newsgroups:comp.lang.java.programmer on 27th March 2002.
 * 
...
public class CSVWriter {
    ...
    public CSVWriter(PrintWriter pw) {
        this(pw, false, ',', System.getProperty("line.separator"));
    } // end of CSVWriter
     ...
     * This is the text leaded by the <code>comment char + " "</code>, given
     * in the constructor.
     * 
     * @param text
    ...
    public void writeCommentln(String text) {
        if (wasPreviousField)
            writeln(); // close open line since we need to
        // start a new one for comment
     ...
     *            contains the value.
     */
    public String writeln(String token) {
        return write(token) + lineSeparator;
    } // end of writeln
    ...
    public String writeln(String[] line) {
        ...
        for (int ii = 0; ii < line.length; ii++) {
            sb.append(write(line[ii]));
        } // end of for

        sb.append(writeln()); // write newLine
        return sb.toString();
