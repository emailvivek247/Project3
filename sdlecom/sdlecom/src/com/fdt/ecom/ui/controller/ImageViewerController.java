	...
	public String downLoadDocument(HttpServletRequest request,
		...
		try {
			...
			if (item != null) {
				...
				if(item.isCertified()){
					this.createCertifiedCopy(imagelocation, locationName, uniqueidentifier, item.getCertifiedDocumentNumber(), caseNumber, caseTitle, caseEvent, byteArrayOutputStream);
