...
public class WebserverHttpInfo extends XMLSerializable{
    ...
    private static final long serialVersionUID = -6387630630175575574L;

    private static final Logger logger = LoggerFactory.getLogger(WebserverHttpInfo.class);
    ...
    public WebserverHttpInfo(HttpServletRequest request) {
        logger.debug("creating new WebserverHttpInfo object from request");
    ...
    public WebserverHttpInfo(String localUrl, String serverUrl) {
        logger.debug("creating new WebserverHttpInfo object from localUrl and serverUrl");
