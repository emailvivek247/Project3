...
/**
 * Just wrap document object To display hit score To return doc content in List,
 * instead of [], to be used by velocity @
 */
public class HitDocument implements SDLIndexDocument {
    ...
    /**
     * Depending on the column type, it returns java.sql.Date => java.util.Date
     * java.sql.Time => java.util.Date java.sql.Timestamp => java.util.Date
     * java.math.BigDecimal => java.lang.Double java.lang.Double =>
    ...
    /**
     * Return a Long object of EPOCH time, and null if date is empty or stored
     * in wrong format.
     */
