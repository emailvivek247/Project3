/*
 * Created on Apr 9, 2006 Copied from
...
public class NumberUtils {
    ...
    public static String int2sortableStr(String val) {
        return int2sortableStr(U.getInt(val,0));
    }
    ...
    public static String long2sortableStr(String val) {
        return long2sortableStr(U.getLong(val, 0l));
    }
    ...
    public static String float2sortableStr(String val) {
        return float2sortableStr(U.getFloat(val, 0f));
    }
    ...
    public static String double2sortableStr(String val) {
        return double2sortableStr(U.getDouble(val, 0d));
    }
